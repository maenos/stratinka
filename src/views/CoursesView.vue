  ...
  meta: [
    {
      name: 'description',
      content:
        'Explorez notre vitrine de cours en ligne. Filtrez par catégorie, niveau et prix pour trouver la formation idéale.',
    },
  ],
})
...
// Watchers
watch([searchQuery, selectedCategories, selectedLevels, selectedPrice], applyFilters, {
  deep: true,
})
      ...
      <aside class="w-full md:w-64 flex-shrink-0 space-y-6">
        ...
        <div class="collapse collapse-arrow border border-base-200 bg-base-100 rounded-box">
          ...
          <div class="collapse-content">
            <div v-for="cat in categoryStore.categories" :key="cat.id" class="form-control">
      ...
      <main class="flex-1">
        ...
        >
          <div
            v-for="n in 6"
            :key="n"
            class="card bg-base-100 w-full shadow-sm h-80 animate-pulse border border-base-200"
          >
        ...
        <!-- Empty State -->
        <div
          v-else-if="!courseStore.loading && courseStore.courses.length === 0"
